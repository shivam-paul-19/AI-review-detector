...
st.markdown("# 🤖 AI Review Detector")
st.caption("Detect whether a product review is written by a human or generated by AI.")
rating = st.slider(label="⭐ Rating (out of 5)", min_value=0, max_value=5)
review = st.text_area(label="🖊️ Enter the review")

if(st.button(label="🔍 Analyze Review") and review != ''):
